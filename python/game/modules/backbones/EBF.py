...
from game.deployment.context import is_export_mode
from game.modules.backbones.RoPosEmb_s2 import SingleRoPosEmb
...
class AttnWROPEX(nn.Module):
    ...
    def forward(self, x):
        ...
        q, k, v = map(lambda value: _to_heads(value, self.num_heads), (q, k, v))
